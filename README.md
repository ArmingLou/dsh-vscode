...
- 📂 **File jumps**: clicking a file path in the panel — paths in model replies, produced-file chips, and tool-call rows such as `read · test/bridge/a.ts` — opens the file in the current VS Code window (instead of the OS default application);
